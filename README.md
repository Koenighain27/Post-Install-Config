...
Alright, now lets configure SLA. SLA plans (Service Level Agreements), provide a length of time in which help desk admins expect tickets to be closed. To configure go to Admin Panel -> Manage -> SLA -> Add New SLA. Create 3 new SLA plans.
<p>
